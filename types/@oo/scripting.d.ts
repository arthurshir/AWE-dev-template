...
declare class AudioManager {
    ...
    addAudioSource(component: Component3D, audioSource: AudioSource, select?: () => AudioTypeData): void;
...
export declare class ComponentManager extends AugmentedGroup {
     ...
     */
    get lookedAtComponent(): Component3D<Component3DData_2>;
    /**
...
declare class GrassInstance {
    ...
    buildCollisionMesh(): {
        ...
        onBeforeRender: (renderer: WebGLRenderer, scene: Scene, camera: Camera_2, geometry: BufferGeometry, material: Material, group: Group) => void;
        onAfterRender: (renderer: WebGLRenderer, scene: Scene, camera: Camera_2, geometry: BufferGeometry, material: Material, group: Group) => void;
        ...
        addEventListener<T extends keyof Object3DEventMap>(type: T, listener: EventListener_2<Object3DEventMap[T], T, any>): void;
        addEventListener<T extends string>(type: T, listener: EventListener_2<    {}, T, any>): void;
        hasEventListener<T extends keyof Object3DEventMap>(type: T, listener: EventListener_2<Object3DEventMap[T], T, any>): boolean;
        hasEventListener<T extends string>(type: T, listener: EventListener_2<    {}, T, any>): boolean;
        removeEventListener<T extends keyof Object3DEventMap>(type: T, listener: EventListener_2<Object3DEventMap[T], T, any>): void;
        removeEventListener<T extends string>(type: T, listener: EventListener_2<    {}, T, any>): void;
...
declare class InstancedWrapperCollisionMesh extends Mesh<BufferGeometry<NormalBufferAttributes>, Material | Material[], Object3DEventMap> {
...
declare class LookatDetector extends AugmentedGroup {
    ...
    private _setCurrent;
    private _emitEvent;
    _doRaycast(): Component3D<Component3DData_5>;
    /**
...
declare class ParticlesComponent_2 extends Component3D<ParticlesComponentData> {
    source: Component3D<Component3DData_6>;
    autoSpawn: boolean;
    button: any;
    button2: any;
...
export declare class PlayerManager {
    ...
    private _spawner;
    private _getSpawner;
    addPlayer(data: PlayerData, opts?: {
        state?: PlayerState;
